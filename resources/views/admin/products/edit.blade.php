                ...
                <form method="post" action="{{ route('admin.products.update') }}" autocomplete="off"
                    ...
                    <div class="card ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input id="measure" name="measure" type="text" value="{{$product->measures}}">
                                </div>
                            </div>
                        </div>
                        {{-- valor --}}
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input id="measure" name="value" type="text" value="{{$product->value}}">
                                </div>
                            </div>
                        </div>
                        {{-- estoque --}}
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input class="form-control" id="amount" name="amount" value="{{ $product->amount }}" type="text">
                                </div>
                            </div>
                        </div>
                        {{-- Descricao --}}
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <textarea class="form-control input-content" name="description"
                                        ...
                                        placeholder="{{ __('Descrição') }}">{{ $product->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" name="measures">
