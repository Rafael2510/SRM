@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('LAC')])
          ...
          <div class="card-body ">
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Eu concordo com as Políticas de Privacidade ') }} <a href="#">{{ __('Privacy Policy') }}</a>
              </label>
            </div>
          </div>
